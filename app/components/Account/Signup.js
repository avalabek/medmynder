...
class Signup extends React.Component {
  ...
  render() {
    return <div className="column row" style={{ backgroundColor: "lime" }}>
        <div className="row">
          <div className="medium-8 medium-offset-2 columns">
            <Messages messages={this.props.messages} />
            <form onSubmit={this.handleSignup.bind(this)}>
              <h4>Create an account and let's see if it renders</h4>
              ...
              <input type="text" name="phone" id="phone" placeholder="Phone" value={this.state.phone} onChange={this.handleChange.bind(this)} autoFocus />
